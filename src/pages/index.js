...
const IndexPage = () => {
  return (
    <Layout pageTitle="">
      <div className="object-contain ml-1 lg:ml-20 lg:mr-20 pb-10">
        ...
        <p className="text-base md:text-xl text-white font-thin pt-96 md:pt-80 lg:pt-52">I'm available for freelance work. Interested in working with me ? </p>
